...
function skeleton_scripts() {
	...
	$body_query_args = array('family' => skeleton_options('body_font').':300,400,700');
	$heading_query_args = array('family' =>	skeleton_options('heading_font').':300,400,700');
	...
	$link_color = skeleton_options('link_color', '#3b3b3b');
	$link_hover_color = skeleton_options('link_hover_color', '#a40a17');
...
if ( !function_exists( 'skeleton_logo' ) ) {
	...
	add_action('skeleton_header','skeleton_logo', 1);
...
if ( !function_exists( 'skeleton_main_menu' ) ) {
	...
	function skeleton_main_menu() {
		echo '<div id="navigation" class="four columns">';
...
function skeleton_widgets_init() {
	...
	register_sidebar( array(
		...
		'description' => __( 'The Top right widget area', 'smpl' ),
		'before_widget' => '<div class="%1$s">',
		'after_widget' => '</div>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
